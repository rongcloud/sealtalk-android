...
public class UserDetailActivity extends TitleBaseActivity implements View.OnClickListener {
        ...
        if (groupEntity != null) {
            ...
            if (groupEntity.getMemberProtection() == 1) {
                FriendStatus friendStatus =
                        FriendStatus.getStatus(latestUserInfo.getFriendStatus());
    ...
    private void updateGroupInfoDes(GroupMemberInfoDes data) {
        if (!TextUtils.isEmpty(data.getGroupNickname())) {
            ...
            grouNickNameTv.setText(
                    getString(R.string.seal_mine_my_account_group_nick_name) + groupNickName);
    ...
    private void updateUserInfo(UserInfo userInfo) {
        ...
        if (friendStatus == FriendStatus.IS_FRIEND || friendStatus == FriendStatus.IN_BLACK_LIST) {
            // 显示好友相关设置
            friendMenuLl.setVisibility(View.VISIBLE);
            ...
            if (!TextUtils.isEmpty(alias)) {
                ...
                String name =
                        getString(R.string.seal_mine_my_account_nickname)
                                + ":"
                                + userInfo.getName();
            ...
            // 当好友时显示手机号码
            //            String phone = getString(R.string.seal_mine_my_account_phone_number) + ":"
        ...
        if (!TextUtils.isEmpty(userInfo.getStAccount())) {
            ...
            String stAccount =
                    getString(R.string.seal_mine_my_account_st_account) + userInfo.getStAccount();
    ...
    private void showOperatePhoneNumDialog() {
        OperatePhoneNumBottomDialog dialog =
                new OperatePhoneNumBottomDialog(sivDesPhone.getValueView().getText().toString());
    ...
    private void startChat() {
        ...
        if (!TextUtils.isEmpty(alias)) {
            ...
            RongIM.getInstance()
                    .startPrivateChat(this, latestUserInfo.getId(), latestUserInfo.getName());
        }
        finish();
    }
                        ...
                        if (TextUtils.isEmpty(inviteMsg) && myUserInfo != null) {
                            ...
                            if (!TextUtils.isEmpty(fromGroupName)) {
                                inviteMsg =
                                        getString(
                                                R.string
                                                        .profile_invite_friend_description_has_group_format,
                                                fromGroupName,
                                                myUserInfo.getName());
                            } else {
                                inviteMsg =
