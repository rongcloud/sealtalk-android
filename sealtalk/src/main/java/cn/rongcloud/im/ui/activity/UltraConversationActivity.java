...
public class UltraConversationActivity extends RongBaseActivity
                        ...
                        new Observer<Boolean>() {
                            ...
                            public void onChanged(Boolean aBoolean) {
                                if (aBoolean) {
                                    ...
                                    switch (conversationIdentifier.getType()) {
    ...
    protected void onResume() {
        ...
        IMManager.getInstance()
                .setLastConversationRecord(
                        conversationIdentifier.getTargetId(), conversationIdentifier.getType());
        setOnLayoutListener();
    }
    ...
    protected void onDestroy() {
        ...
        // 清除会话记录
        IMManager.getInstance().clearConversationRecord(conversationIdentifier.getTargetId());
    ...
    private void refreshScreenCaptureStatus() {
        ...
        if (conversationIdentifier.getType().equals(Conversation.ConversationType.PRIVATE)
                || conversationIdentifier.getType().equals(Conversation.ConversationType.GROUP)) {
                ...
                new ScreenCaptureUtil.ScreenShotListener() {
                    ...
                    public void onScreenShotComplete(String data, long dateTaken) {
                        Conversation.ConversationType mConversationType =
                                conversationIdentifier.getType();
                        String mTargetId = conversationIdentifier.getTargetId();
                    ...
                    public void onFaild(Exception e) {
                        ...
                        if (e instanceof SecurityException) {
                            CheckPermissionUtils.requestPermissions(
                                    UltraConversationActivity.this,
                                    permissions,
    ...
    private void initViewModel() {
        String mTargetId = conversationIdentifier.getTargetId();
        Conversation.ConversationType mConversationType = conversationIdentifier.getType();
    ...
    private void initView() {
        initTitleBar(conversationIdentifier.getType());
        initAnnouceView();
    ...
    private void showRencentPicturePop(int h) {
        ...
        // 判断是否有读取文件的权限
        if (!CheckPermissionUtils.requestPermissions(
                UltraConversationActivity.this, permissions, REQUEST_CODE_PERMISSION)) {
            return;
        }
    ...
    private static class DelayDismissHandler extends Handler {
        ...
        public DelayDismissHandler(UltraConversationActivity activity) {
    ...
    private void initTitleBar(Conversation.ConversationType conversationType) {
        ...
        mTitleBar.setOnRightIconClickListener(v -> toDetailActivity());
    ...
    public void onEventMainThread(DeleteFriendEvent event) {
        if (event.result && event.userId.equals(conversationIdentifier.getTargetId())) {
