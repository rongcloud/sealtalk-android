...
/** Created by AMing on 15/11/2. Company RongCloud */
@SuppressLint("AppCompatCustomView")
public class ClearWriteEditText extends EditText
    ...
    private void init(AttributeSet attrs) {
        ...
        TypedArray ta =
                attrs == null
                        ? null
                        : getContext()
                                .obtainStyledAttributes(attrs, R.styleable.ClearWriteEditText);
        if (ta != null) {
