    ...
    private void intData() {
        ...
        RongIMClient.getInstance()
                .setMessageExpansionListener(
                        new RongIMClient.MessageExpansionListener() {
                            @Override
                            public void onMessageExpansionUpdate(
                                    Map<String, String> expansion, Message message) {
                                addToList(
                                        getStringDate()
                                                + "扩展消息设置监听: UID "
                                                + message.getUId()
                            ...
                            @Override
                            public void onMessageExpansionRemove(
                                    List<String> keyArray, Message message) {
                                addToList(
                                        getStringDate()
                                                + "扩展消息删除监听: UID "
                                                + message.getUId()
                ...
                .removeMessageExpansion(
                        ...
                        new RongIMClient.OperationCallback() {
                            ...
                            public void onError(RongIMClient.ErrorCode errorCode) {
                                Toast.makeText(
                                                getApplicationContext(),
                                                "删除失败，ErrorCode : " + errorCode.getValue(),
                                                Toast.LENGTH_LONG)
                                        .show();
                            }
                        });
                ...
                .sendMessage(
                        ...
                        new IRongCallback.ISendMessageCallback() {
                            ...
                            public void onSuccess(io.rong.imlib.model.Message message) {
                                Toast.makeText(
                                                MessageExpansionDetailActivity.this,
                                                "发送消息成功",
                                                Toast.LENGTH_SHORT)
                                        .show();
