...
public class CustomUltraConversationFragment extends ConversationFragment
        implements IRongCoreListener.UltraGroupMessageChangeListener {

    static final String TAG = CustomUltraConversationFragment.class.getCanonicalName();
    ...
    public CustomUltraConversationFragment() {
        super();
    }
