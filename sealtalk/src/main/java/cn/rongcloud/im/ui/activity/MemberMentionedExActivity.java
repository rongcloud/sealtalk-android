...
public class MemberMentionedExActivity extends TitleBaseActivity {
    ...
    private void initView() {
        ...
        menberListlv.setOnItemClickListener(
        ...
        // 设置右侧触摸监听
        sideBarSb.setOnTouchingLetterChangedListener(
    ...
    private void initViewModel() {
        ...
        Conversation.ConversationType conversationType =
                Conversation.ConversationType.setValue(
                        getIntent().getIntExtra(RouteUtils.CONVERSATION_TYPE, 0));
        memberMentionedViewModel =
                ViewModelProviders.of(
                                this,
                                new MemberMentionedViewModel.Factory(
                                        targetId, conversationType, getApplication()))
                        .get(MemberMentionedViewModel.class);
