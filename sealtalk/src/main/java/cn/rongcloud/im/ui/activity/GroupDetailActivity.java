...
public class GroupDetailActivity extends TitleBaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        memberAdapter.setOnItemClickedListener(
                new GridGroupMemberAdapter.OnItemClickedListener() {
                    @Override
        ...
        notifyNoticeSiv.setSwitchCheckListener(
        ...
        onTopSiv.setSwitchCheckListener(
                (buttonView, isChecked) ->
        ...
        isToContactSiv.setSwitchCheckListener(
        ...
        screenShotSiv.setSwitchTouchListener(
        ...
        screenShotSiv.setSwitchCheckListener(
                new CompoundButton.OnCheckedChangeListener() {
                    @Override
                    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                        // 初始化不触发逻辑
    ...
    private void initViewModel() {
        ...
        conversationSettingViewModel
                ...
                .observe(
                        this,
                        new Observer<Conversation.ConversationNotificationStatus>() {
                            @Override
                ...
                .observe(
                        ...
                        new Observer<OperationResult>() {
                            ...
                            public void onChanged(OperationResult operationResult) {
                                ...
                                } else if (operationResult.mAction.equals(
                                        OperationResult.Action.CLEAR_CONVERSATION_MESSAGES)) {
        ...
        // 添加群组成员结果
        groupDetailViewModel
                .getAddGroupMemberResult()
                .observe(
                        this,
                        new Observer<Resource<List<AddMemberResult>>>() {
                            @Override
        ...
        // 获取群公告
        groupDetailViewModel
                .getGroupNoticeResult()
                .observe(
                        this,
                        new Observer<Resource<GroupNoticeResult>>() {
                            @Override
        ...
        groupDetailViewModel
                ...
                .observe(
                        this,
                        new Observer<Resource<Integer>>() {
                            @Override
                            public void onChanged(
                                    Resource<Integer> groupRegularClearResultResource) {
                                if (groupRegularClearResultResource.status != Status.LOADING
                                        && groupRegularClearResultResource.data != null) {
                                    updateCleanTimingSiv(groupRegularClearResultResource.data);
                                } else if (groupRegularClearResultResource.status
                                        != Status.LOADING) {
                                    cleanTimingSiv.setValue(
                                            getString(R.string.seal_set_clean_time_state_not));
                                }
                            }
                        });
    ...
    private void updateGroupInfoView(GroupEntity groupInfo) {
        // 标题
        String title =
                getString(R.string.profile_group_info) + "(" + groupInfo.getMemberCount() + ")";
        titleBar.setTitle(title);

        // 群成员数量
        String allMemberTxt =
                getString(R.string.profile_all_group_member)
                        + "("
                        + groupInfo.getMemberCount()
                        + ")";
        ...
        dialog.setInputDialogListener(
                new SimpleInputDialog.InputDialogListener() {
                    ...
                    public boolean onConfirmClicked(EditText input) {
                        ...
                        if (name.length() < Constant.GROUP_NAME_MIN_LENGTH
                                || name.length() > Constant.GROUP_NAME_MAX_LENGTH) {
                            ToastUtils.showToast(
                                    getString(
    ...
    private void setGroupPortrait() {
        ...
        builder.setOnSelectPictureListener(
                new SelectPictureBottomDialog.OnSelectPictureListener() {
                    @Override
    ...
    private void showRegualrClearDialog() {
        ...
        dialog.setOnDialogButtonClickListener(
                new SelectCleanTimeDialog.OnDialogButtonClickListener() {
                    @Override
                    public void onThirtySixHourClick() {
                        setRegularClear(
                                RegularClearStatusResult.ClearStatus.THIRTY_SIX_HOUR.getValue());
                    }
