...
public class ChatRoomStatusDeatilActivity extends TitleBaseActivity
    ...
    private void initViewModel() {
        ...
        chatRoomViewModel
                .getChatRoomEventLiveData()
                .observe(
                        this,
                        new Observer<ChatRoomEvent>() {
                            @Override
    ...
    private void initData() {
        ...
        for (Map.Entry<String, Message> entry : historyMessageList) {
            ...
            if (content.getType() == 1) {
                contentList.add(
                        formatTime(message.getSentTime())
                                + " 通知消息，设置成功 "
                                + "object="
                ...
                new RongChatRoomClient.ChatRoomMemberActionListener() {
                    ...
                    public void onMemberChange(
                        ...
                        new AlertDialog.Builder(
                                        ChatRoomStatusDeatilActivity.this,
    ...
    private void removeKVByBatch(boolean force) {
        final ChatRoomStatusInputDialog chatRoomStatusInputDialog =
                new ChatRoomStatusInputDialog(this, ChatRoomStatusInputDialog.TYPE_REMOVE_BATCH);
        chatRoomStatusInputDialog
                .getSureView()
                .setOnClickListener(
                        new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                String keyList =
                                        chatRoomStatusInputDialog.getEtKey().getText().toString();
                                ...
                                try {
                                    RongChatRoomClient.getInstance()
                                            .deleteChatRoomEntries(
                                                    ...
                                                    keyListParams,
                                                    force,
                                                    new IRongCoreCallback.SetChatRoomKVCallback() {
                                                        @Override
                                                        public void onSuccess() {
                                                            Log.e(
                                                                    "ChatRoomStatusDeatil",
                                                                    "setChatRoomEntries===onSuccess");
    ...
    private void setKVByBatch(boolean force) {
        final ChatRoomStatusInputDialog chatRoomStatusInputDialog =
                new ChatRoomStatusInputDialog(this, ChatRoomStatusInputDialog.TYPE_SET_BATCH);
        chatRoomStatusInputDialog
                .getSureView()
                .setOnClickListener(
                        new View.OnClickListener() {
    ...
    private void setKey() {
        final ChatRoomStatusInputDialog chatRoomStatusInputDialog =
                new ChatRoomStatusInputDialog(this);
        chatRoomStatusInputDialog
                .getSureView()
                .setOnClickListener(
                        new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                boolean isAutoDel =
                                        chatRoomStatusInputDialog.getCbAutoDel().isChecked();
                                boolean isSendMsg =
                                        chatRoomStatusInputDialog.getCbIsSendMsg().isChecked();
                                String extra =
                                        chatRoomStatusInputDialog.getEtExtra().getText().toString();
                                Log.e(
                                        "ChatRoomStatusDeatil",
                                        "==setkey=="
                                                + "key:"
    ...
    private void removeKey() {
        final ChatRoomStatusInputDialog chatRoomStatusInputDialog =
                new ChatRoomStatusInputDialog(this, ChatRoomStatusInputDialog.TYPE_REMOVE);
        chatRoomStatusInputDialog
                .getSureView()
                .setOnClickListener(
                        new View.OnClickListener() {
                                        ...
                                        .forceRemoveChatRoomEntry(
                                                ...
                                                new RongIMClient.OperationCallback() {
                                                    ...
                                                    public void onSuccess() {
                                                        Log.e(
                                                                "ChatRoomStatusDeatil",
                                                                "forceRemoveChatroomEntry===onSuccess");
                                                    ...
                                                    public void onError(
                                                        ...
                                                        Log.e(
                                                                "ChatRoomStatusDeatil",
                                                                "forceRemoveChatroomEntry===onError"
                                                                        + errorCode);
                                                        addToList(
                                                                getStringDate()
                                                                        + " 删除失败，"
                ...
                .getAllChatRoomEntries(
                        ...
                        new RongIMClient.ResultCallback<Map<String, String>>() {
                            ...
                            public void onError(RongIMClient.ErrorCode e) {
                                Log.e(
                                        "ChatRoomStatusDeatil",
                                        e.toString() + "errorcode:" + e.getValue());
    ...
    private void getKeysByBatch() {
        final ChatRoomStatusInputDialog chatRoomStatusInputDialog =
                new ChatRoomStatusInputDialog(this, ChatRoomStatusInputDialog.TYPE_GET);
        chatRoomStatusInputDialog
                .getSureView()
                .setOnClickListener(
                        new View.OnClickListener() {
    ...
    public void onEventMainThread(OnKVStatusEvent event) {
        ...
        if (!roomId.equals(event.mRoomId)
                || (cacheKVStatusEvent != null && cacheKVStatusEvent.equals(event))) {
            return;
        }
    ...
    private void removeOldMessage() {
        ...
        Collections.sort(
                historyMessageList,
                new Comparator<Map.Entry<String, Message>>() {
                    public int compare(
                            Map.Entry<String, Message> o1, Map.Entry<String, Message> o2) {
                        try {
            ...
            if (convertView == null) {
                convertView =
                        LayoutInflater.from(parent.getContext())
                                .inflate(R.layout.item_chat_room_status, null);
            }
