...
public class MainViewModel extends AndroidViewModel {
    ...
    UnReadMessageManager.IUnReadMessageObserver observer =
            new UnReadMessageManager.IUnReadMessageObserver() {
                @Override
    ...
    public void startPrivateChat(String userId) {
        ...
        LiveData<FriendShipInfo> friendShipInfoLiveData =
                friendTask.getFriendShipInfoFromDB(userId);
        privateChatLiveData.addSource(
                friendShipInfoLiveData,
