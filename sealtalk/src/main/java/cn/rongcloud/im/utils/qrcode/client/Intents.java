...
public final class Intents {
    ...
    public static final class Scan {
        ...
        /**
         * By default, sending this will decode all barcodes that we understand. However it may be
         * useful to limit scanning to certain formats. Use {@link
         * android.content.Intent#putExtra(String, String)} with one of the values below.
         *
         * <p>Setting this is effectively shorthand for setting explicit formats with {@link
         * #FORMATS}. It is overridden by that setting.
         */
         ...
         * com.google.zxing.BarcodeFormat}s, e.g. {@link com.google.zxing.BarcodeFormat#EAN_13}.
         ...
         * Overrides the default camera that would otherwise would have been selected. If provided,
         * should be an int.
         */
        ...
        /**
         * Set to true to return a path to the barcode's image as it was captured. Defaults to
         * false.
         */
         ...
         * contents can be retrieved with {@link android.content.Intent#getStringExtra(String)}. If
         * the user presses Back, the result code will be {@link
         ...
         * determine which barcode format was found. See {@link com.google.zxing.BarcodeFormat} for
         * possible values.
         */
        ...
        /**
         * Prefix for keys that map to the values of {@link
         * com.google.zxing.ResultMetadataType#BYTE_SEGMENTS}, if available. The actual values will
         * be set under a series of keys formed by adding 0, 1, 2, ... to this prefix. So the first
         * byte segment is under key "SCAN_RESULT_BYTE_SEGMENTS_0" for example. Call {@link
         * android.content.Intent#getByteArrayExtra(String)} with these keys.
         */
        public static final String RESULT_BYTE_SEGMENTS_PREFIX = "SCAN_RESULT_BYTE_SEGMENTS_";

        /**
         * Call {@link android.content.Intent#getStringExtra(String)} with {@link
         * #RESULT_BARCODE_IMAGE_PATH} to get a {@code String} path to a cropped and compressed png
         * file of the barcode's image as it was displayed. Only available if {@link
         * cn.rongcloud.rce.kit.qrcode.IntentIntegrator#setBarcodeImageEnabled(boolean)} is called
         * with true.
         */
