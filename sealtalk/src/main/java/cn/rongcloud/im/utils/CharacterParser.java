...
public class CharacterParser {
    ...
    public static SpannableStringBuilder getColoredChattingRecord(
            String filterStr, MessageContent messageContent, Context context) {
        ...
        if (messageContent instanceof RichContentMessage) {
            ...
            if (messageText.length() == 0) {
                SpannableStringBuilder spannableStringBuilder =
                        new SpannableStringBuilder(context.getString(R.string.msg_reference_link));
    ...
    public static SpannableStringBuilder getOmitColored(
            String filterStr, String content, int type, Context context) {
        SpannableStringBuilder messageText = new SpannableStringBuilder();
        ...
        if (lowerCaseText.contains(lowerCaseFilterStr)) {
            ...
            if (length <= 12) {
                ...
                if (totalLength < 12) {
                    ...
                    SpannableStringBuilder spannableStringBuilder =
                            new SpannableStringBuilder(smallerString);
                    spannableStringBuilder.setSpan(
                            new ForegroundColorSpan(Color.parseColor("#0099ff")),
                            firstIndex,
                            firstIndex + filterStr.length(),
                    ...
                    if (firstIndex >= 5) {
                        ...
                        smallerStringLowerCase =
                                lowerCaseText.substring(firstIndex - 5, firstIndex + 7);
                        ...
                        smallerStringLowerCase =
                                lowerCaseText.substring(firstIndex, firstIndex + 12);
                    ...
                    spannableStringBuilder.setSpan(
                            new ForegroundColorSpan(Color.parseColor("#0099ff")),
                            index,
                            getSmallerLength(smallerString.length(), index + filterStr.length()),
                            Spanned.SPAN_INCLUSIVE_EXCLUSIVE);
                    builder.append(spannableStringBuilder);
                    builder.append("...");
                    return finalBuilder.append(builder);
