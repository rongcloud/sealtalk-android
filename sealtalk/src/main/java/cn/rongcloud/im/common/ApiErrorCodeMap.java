...
public class ApiErrorCodeMap {
    ...
    /** 一般 url 映射表 */
    private static final HashMap<String, Integer> FULL_PATH_PREFIX_MAP =
            new HashMap<String, Integer>() {
                {
                    ...
                    put(
                            SealTalkUrl.GROUP_GET_ALL_IN_CONTACT,
                            SealTalkUrlCode.GROUP_GET_ALL_IN_CONTACT);
                    ...
                    put(
                            SealTalkUrl.GET_DISCOVERY_CHAT_ROOM,
                            SealTalkUrlCode.GET_DISCOVERY_CHAT_ROOM);
                    ...
                    put(
                            SealTalkUrl.GROUP_SET_CERTIFICATION,
                            SealTalkUrlCode.GROUP_SET_CERTIFICATION);
    ...
    /** 查询类 url 映射 由于此类 url 没法直接用 key 去进行查询，所以单独列出，用正则去区分查询 */
    public static final HashMap<String, Integer> QUERY_PATH_REG_PREFIX_MAP =
            new HashMap<String, Integer>() {
                {
                    ...
                    put(
                            "/user/find/[a-zA-Z0-9+=-_]*/[a-zA-Z0-9+=-_]*",
                            SealTalkUrlCode.FIND_FRIEND);
                }
            };
